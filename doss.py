...
# please enter your wlan my is 0 change this var to your wlan num 
wlan = 0
...
# Automatically select the first available interface (index 0)
wifi_interface_choice = wlan
hacknic = check_wifi_result[wifi_interface_choice]
print(f"Automatically selected WiFi interface: {hacknic}")
...
try:
    ...
    # Restarting NetworkManager to restore default system networking state
